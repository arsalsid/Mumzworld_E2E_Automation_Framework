...
public class Listener extends DriverFactory implements ITestListener {
    ...
    public void onTestSuccess(ITestResult iTestResult) {
        ...
        getTest().log(Status.PASS, "tests.Test passed");
    }
    @Override
    public void onTestFailure(ITestResult iTestResult) {
        ...
        getTest().log(Status.FAIL, "tests.Test Failed");
    ...
    public void onTestSkipped(ITestResult iTestResult) {
        ...
        getTest().log(Status.SKIP, "tests.Test Skipped");
    }
    @Override
    public void onTestFailedButWithinSuccessPercentage(ITestResult iTestResult) {
        Reporter.log("tests.Test failed but it is in defined success ratio " + getTestMethodName(iTestResult));
    }
}
